...
const App = () => {
  ...
  return (
    <div>
      <Main/>
      <button className={style.newBtn} onClick={() => setOpenModal(true)}>Login</button>
            ...
            <form className={style.formStyle} onSubmit={handleSubmit}>
              <div className={style.columnfile}>
                <div className={style.columnA}>
                  ...
                  <div className={style.lineGroup}>
                      <Field name="password" placeholder="Password" validate = {required} type="password">
                        {({input,meta,placeholder}) => (
                          <div>
                  ...
                  <button className={style.BtnModCheck} type="submit" onClick={toggleLog}>Confirm</button>
                  <button className={style.BtnModCancel} onClick={() => setOpenModal(false)}>Cancel</button>
                </div>             
              </div>
            </form>
          )}
